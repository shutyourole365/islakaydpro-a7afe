                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <button
                          aria-label="Like post" onClick={() => handleLikePost(post.id)}
                        ...
                        <button className="flex items-center gap-1 px-3 py-1 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Comment on post">
                          <MessageCircle className="w-4 h-4" />
                          <span className="text-sm">{post.comments}</span>
                        </button>

                        <button className="flex items-center gap-1 px-3 py-1 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Share post">
                      ...
                      <button
                        aria-label="Bookmark post" onClick={() => handleBookmarkPost(post.id)}
