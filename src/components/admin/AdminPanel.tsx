                    ...
                    <tr key={user.id} className="border-t border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-1">
                          <button className="p-2 hover:bg-gray-100 rounded-lg" title="View" aria-label="Icon button">
                            <Eye className="w-4 h-4 text-gray-600" />
                          </button>
                          <button className="p-2 hover:bg-gray-100 rounded-lg" title="Edit">
                            <Edit className="w-4 h-4 text-gray-600" />
                          </button>
                          <button className="p-2 hover:bg-gray-100 rounded-lg" title="Email" aria-label="Icon button">
                    ...
                    <tr key={report.id} className="border-t border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-1">
                          ...
                          <button className="p-2 hover:bg-red-50 rounded-lg" title="Dismiss" aria-label="Icon button">
