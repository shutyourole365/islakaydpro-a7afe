        ...
        <div className="p-6 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-t-3xl text-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
             ...
             aria-label="Icon button (BlockchainContract.tsx)">
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="p-1.5 hover:bg-gray-200 rounded-lg transition-colors" aria-label="Icon button (BlockchainContract.tsx)">
