      ...
      <div className="relative w-full sm:w-[440px] sm:h-[600px] h-full bg-white sm:rounded-2xl shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-teal-500 to-emerald-500">
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 rounded-full hover:bg-white/10 text-white transition-colors" aria-label="Icon button (LiveChat.tsx)">
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50">
          <div className="flex items-end gap-2">
            <button className="p-2.5 rounded-full hover:bg-gray-200 text-gray-600 transition-colors" aria-label="Icon button (LiveChat.tsx)">
