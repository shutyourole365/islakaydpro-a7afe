...
export default function FeatureShowcase({ onFeatureSelect, onClose }: FeatureShowcaseProps) {
  ...
  const features: Feature[] = [
    ...
    // NEWEST Features (10-15) - Availability, Revenue, Certification, Agreements, Support
    {
      ...
      name: 'Equipment Availability Calendar',
      description: 'Interactive calendar showing equipment availability with booking slots and pricing',
      icon: <Calendar className="w-6 h-6" />,
    ...
    },
    {
      ...
      name: 'Owner Revenue Dashboard',
      description: 'Comprehensive revenue analytics, earnings tracking, and transaction history for equipment owners',
    ...
    },
    {
      ...
      description: 'Manage equipment certifications, compliance requirements, and safety documentation',
    ...
    },
    {
      ...
      description: 'Digital contract creation with templates, e-signature, and automated agreement management',
    ...
    },
    {
      ...
      description: 'Professional support ticket system with categorization, prioritization, and tracking',
